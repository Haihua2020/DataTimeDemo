...
public class PopDateHelper2 {
    ...
    private void initData() {
        listDate = DatePackerUtil2.getDateList();
        //原本的时间表示整点和半点
//        listTime = DatePackerUtil2.getTimeAllList();
        // 上下午
        listAmFm = DatePackerUtil2.getAmfM();
        // 小时
        listHour = DatePackerUtil2.getAllHour();
        // 分钟
        listMin = DatePackerUtil2.getAllMin();
    }
    ...
    private void initView() {
        ...
        loopView1.setCurrentItem(7);


        SimpleDateFormat sdf = new SimpleDateFormat("HH");
        long current_time = System.currentTimeMillis();
        int HH = Integer.valueOf(sdf.format(new Date(current_time)));
//        loopView2.setList(listTime);
        ...
        loopView2.setCurrentItem(hh - 1);

        sdf = new SimpleDateFormat("mm");
        int mm = Integer.valueOf(sdf.format(new Date(current_time)));
        loopView4.setList(listMin);
        loopView4.setNotLoop();
        loopView4.setCurrentItem(mm);
